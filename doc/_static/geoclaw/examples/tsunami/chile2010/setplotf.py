...
#--------------------------
    ...
    plotitem.contour_levels = linspace(-0.2,0.2,5)
    plotitem.fill_cmap = geoplot.tsunami_colormap
    plotitem.fill_cmin = -0.2
    plotitem.fill_cmax = 0.2
    plotitem.add_colorbar = True
    plotitem.amr_celledges_show = [0,0,0]
    plotitem.patchedges_show = 1
    #plotitem.kwargs = {'extend':'neither'}

    plotitem = plotaxes.new_plotitem(plot_type='2d_contour')
    plotitem.show = False
    plotitem.plot_var = geoplot.surface_or_depth
    plotitem.contour_levels = linspace(-0.2,0.2,9)
